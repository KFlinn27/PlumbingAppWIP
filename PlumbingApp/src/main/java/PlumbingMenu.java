...
//        return wrapOdd ? wrapped.concat("-") : wrapped;
    ...
    public String createTask() {
        System.out.println("Please enter the task you would like to create based on the following format;");
        System.out.println("Name of task|cost as 199.99|description|material|labor as 4.25");
        System.out.println("Seperate each item using '|', for cost/labor only enter numbers, no symbols or letters");
        String task = "";
        try {
